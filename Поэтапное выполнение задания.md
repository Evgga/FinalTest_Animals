...
- Реализовать навигацию по меню
  ...
  15. Создайте класс Счетчик ([ссылка на счетчик](https://github.com/Evgga/FinalTest_Animals/blob/main/animals/src/Controller/Counter.java)), у которого есть метод add(), увеличивающий̆
